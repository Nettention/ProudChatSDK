...
namespace Proud 
{
	...
	// 굉장히 많은 수의 문자열 인스턴스가 반복될 경우 메모리를 아끼기 위한 용도
	class  CStringPool : public DllSingleton<CStringPool>
	{
...
#pragma pop_macro("new")
		...
		PROUD_API CStringPool();
		PROUD_API ~CStringPool();
		PROUD_API const String GetString(const Proud::String& str);
